...
module.exports = {
     ...
     */
    botname: process.env.BotName || "botz ᴠ2",
    footer: process.env.Footer || "© 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 manz 𝐁𝐨𝐭",
     ...
     */
    ownername: process.env.Owner_Name || "Manz",
    ownernumber: process.env.Owner_Number || "60102810046",
    instagramId: process.env.Insta || "manzx666",

    /**
     * other details and parameters
     */
    author: process.env.Author || "𝐁𝐨𝐭𝐳 🌚🌙",
    packname: process.env.PackName || "𝕼𝖚𝖊𝖊𝖓 𝕬𝖓𝖞𝖆 𝖁2 𝕾𝖙𝖎𝖈𝖐𝖊𝖗 𝕻𝖆𝖈𝖐 🪀",
    socialLink: process.env.Web || "https://github.com/manzx666",
    ...
    mongoUrl: process.env.MongoDB || "mongodb+srv://manz:aiman123@cluster0z.4wolx.mongodb.net/",
    sessionId: process.env.SESSION_ID || "HYJIBD4i0ior88Pm_A_N_Y_A_V_2_EMPZ",
